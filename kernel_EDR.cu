...
//*/
//
//__global__ void EDRDistance_Batch(int queryTaskNum, TaskInfoTableForSimilarity* taskInfoTable, SPoint *queryTra, SPoint *candidateTra, int* queryTraOffset, OffsetTable* candidateTraOffset, int* queryLength, int *candidateLength, int** stateTableGPU, int *result) {
//	int blockID = blockIdx.x;
//	int threadID = threadIdx.x;
